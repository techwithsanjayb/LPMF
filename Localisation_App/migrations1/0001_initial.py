# Generated by Django 3.2.9 on 2022-07-02 13:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SuccessStories_Upload_Image_1', models.ImageField(blank=True, null=True, upload_to='Localisation_App/media')),
                ('SuccessStories_Upload_Image_2', models.ImageField(blank=True, null=True, upload_to='Localisation_App/media')),
                ('SuccessStories_Upload_Image_3', models.ImageField(blank=True, null=True, upload_to='Localisation_App/media')),
                ('SuccessStories_Upload_Image_4', models.ImageField(blank=True, null=True, upload_to='Localisation_App/media')),
                ('SuccessStories_Upload_Image_5', models.ImageField(blank=True, null=True, upload_to='Localisation_App/media')),
                ('SuccessStories_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Localisation_App.successstrories_category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ResourceData_UploadSupportDocument', models.FileField(blank=True, null=True, upload_to='Localisation_App/media/ResourceDataDocument')),
                ('ResourceData_UploadResourceCode', models.FileField(blank=True, null=True, upload_to='Localisation_App/media/ResourceData')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Article_Image', models.ImageField(null=True, upload_to='Localisation_App/media')),
